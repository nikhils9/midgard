...
\begin{align*}
    ...
    \begin{array}{ll}
        \T{spend\_inputs} : & \T{Set(Input)} \\
        \varnothing\;\T{collateral\_inputs} : & \quad?\;\T{Set(Input)} \\
        \T{reference\_inputs} : & \quad?\;\T{Set(Input)} \\
        \T{outputs} : & \T{[Output]} \\
...
\begin{align*}
    ...
    \begin{array}{ll}
        \T{spend\_inputs} : & \mathcal{H}(\T{[Input]}) \\
        \T{reference\_inputs} : & \quad?\;\mathcal{H}(\T{[Input]}) \\
